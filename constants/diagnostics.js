...
module.exports = {
  ...
  xdsl: {
    FR: {
      ...
      hour: "heures",
      minute: "minutes",
      accessIsOperational: "accès opérationelle",
      checkInfrastructure: "vérification de l'infrastructure",
      configureAccessOnOVH: "configuration de l'accès chez OVH",
      orderPayed: "paiement de la commande",
      orderReceived: "commande reçue",
      orderTreatment: "traitement de la commande",
      sendModem: "envoie du modem",
      sendOrderToProvider: "transmission de la commande au prés du FAI",
      setupCustomerPremisesEquipment: "envoie de l'équipement",
      waitingForProviderInstallReport: "attente du rapport du FAI",
      ...
      orderStepStatus: "\t- l'étape %1$s n'est pas encore finie, elle est actuellement dans l'état : %2$s. Cette étape durera environ %3$s.\n",
