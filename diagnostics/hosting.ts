...
import * as utils from "../bots/utils";
import { Button, ButtonsMessage, TextMessage } from "../platforms/generics";
...
export default {
  checkWebsite (res, hosting, domain, hostingEmails, ssl /* , statistics*/) {
    ...
    let responses: Array<any> = this.checkEmailsState(hosting, hostingEmails);
