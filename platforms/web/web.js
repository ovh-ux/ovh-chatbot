...
const { ButtonsListMessage, Button, TextMessage, ButtonsMessage, CardMessage } = require("../generics");
const WebMessage = require("../../models/web.model");
const config = require("../../config/config-loader").load();
const { camelCase } = require("lodash");
const { textMessageAdapter, buttonAdapter, buttonListAdapter, cardMessageAdapter } = require("./web_adapters");
...
function parseMsg (RawResponses) {
  ...
  return responses.map((uResponse) => {
    ...
    if (uResponse instanceof CardMessage) {
      return cardMessageAdapter(uResponse);
    }
