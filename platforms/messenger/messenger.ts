...
import { textMessageAdapter, buttonsListMessageAdapter, buttonsMessageAdapter } from "./messenger_adapters";
 ...
 *
 */
export function sendButtonMessage (recipientId, text, title, url) {
  const messageData = {
    recipient: {
      id: recipientId
    },
 ...
 */
export function sendAccountLinking (recipientId, url) {
  const messageData = {
    recipient: {
      id: recipientId
    },
...
export function send (recipientId, message) {
